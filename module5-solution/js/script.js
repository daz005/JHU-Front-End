...
function chooseRandomCategory (categories) {
  ...
  // console.log("categories[randomArrayIndex]=" + categories[randomArrayIndex]);
  // console.log("name=" + categories[randomArrayIndex].name);
  // console.log("short_name=" + categories[randomArrayIndex].short_name);
